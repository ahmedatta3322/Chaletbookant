        ...
        <>
          ...
          {chalet && !chalet.cover && (
            <div className="imgCard">
              <Image
                width={`${
                  screenWidth === 1920 ? 177 : screenWidth === 1360 ? 191 : 177
                }`}
                height={`${
                  screenWidth === 1920 ? 127 : screenWidth === 1360 ? 89.5 : 83
                }`}
                src="error"
          ...
          <div className="footerCard">
            <NavLink
              ...
              to={{
                pathname: `/viewchalet/${chalet && chalet.id}`,
                // aboutProps: {
                //   state: chalet,
                // },
              }}
      ...
      {userChalet !== undefined && (
        <>
          {userChalet && userChalet.cover !== null && (
            <Card.Img
              variant="top"
              src={`${userChalet && userChalet.cover}`}
              className={`${
                match.url.slice(1, 8) === "profile"
                  ? `profile-imgCard`
                  : `imgCard`
